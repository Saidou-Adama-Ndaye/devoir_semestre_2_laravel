...
@include('frontend.layouts.inc.breadcrumb', ['page_name' => 'Panier'])
                ...
                <table class="table-responsive cart-wrap">
                    <thead>
                        <tr>
                            ...
                            <th class="ptice">Prix</th>
                            <th class="quantity">Quantité</th>
                            <th class="total">Total</th>
                            <th class="remove">Remise</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <div class="cartcupon-wrap">
                            ...
                            <div class="cupon-wrap">
                                <form action="{{ route('coupon.apply') }}" method="post">
                                    @csrf
                                    <input type="text" name="coupon_name" class="form-control" placeholder="Coupon Code">
