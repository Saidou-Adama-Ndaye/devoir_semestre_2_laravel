...
<div class="row">
    <div class="col-12">
        <h1>Le restaurant groupe5 vous souhaite la bienvenue !</h1>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="d-flex">
            <div class="dropdown-as-select me-3" data-setactive="false" data-childselector="span">
                <a class="pe-0 pt-0 align-top lh-1 dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
                    <span class="small-title">Tableau récapitulatif</span>
                </a>
            </div>
        </div>
        <div class="mb-5">
            <div class="row g-2">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card h-100 hover-scale-up cursor-pointer">
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="cs-icon cs-icon-server text-primary">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card h-100 hover-scale-up cursor-pointer">
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="cs-icon cs-icon-user text-primary">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card h-100 hover-scale-up cursor-pointer">
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="cs-icon cs-icon-message text-primary">
        ...
        <div class="table-responsive my-2">
            <table class="table table-hover" id="dataTable">
                <thead class="text-primary">
                    ...
                    <th>Date Commande</th>
                    <th>Total partiel (Francs CFA)</th>
                    <th>Remise (Francs CFA)</th>
                    <th>Total (Francs CFA)</th>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td> {{ $loop->index+1 }} </td>
                        <td>
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal{{ $order->id }}">Details commande
                            </button>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="width: 800px;">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="#modal{{ $order->id }}Title">Numéro commande
                                                #{{ $order->id }}</h5>
                                                    ...
                                                    <div class="col-md-12">
                                                        <table class="table table-striped table-inverse table-responsive">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="mt-5">
                                                                    <td colspan="50">
                                                                        <p class="text-primary">Adresse de facturation:</p>
                                                                        <p>Recipient: {{ $order->billing->name }}</p>
                                                                        <p>Contact: {{ $order->billing->phone }}</p>
                                                                        <p>Adresse: {{ $order->billing->address }}</p>
...
<script>
    $(document).ready(function() {
        ...
        $('#sweetAlert').click(function(event) {
...
<script>
    ...
    const myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Total Orders',
                data: <?php echo json_encode($order_yearwise, JSON_THROW_ON_ERROR) ?>,
                backgroundColor: [
                    'rgba(54, 162, 235, 0.2)',
